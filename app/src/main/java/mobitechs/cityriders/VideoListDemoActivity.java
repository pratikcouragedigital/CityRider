...
//    }
    ...
    public static final class VideoListFragment extends ListFragment {
        ...
        static {
            ...
            list.add(new VideoEntry("First Night Ride of City Riders l Ambarnath to Lonavla ", "qb9i2mfkpmY"));
            list.add(new VideoEntry("Taking delivery of Suzuki Gixxer 2017 SF with ABS top mode", "Il7FUE_hdVA"));
            list.add(new VideoEntry("Surprise Ride", "dOb5DjOXsjU"));
            list.add(new VideoEntry("Happy Dusshera", "rfMDd72HOCM"));
            list.add(new VideoEntry("Come one come all", "aBXjwwg3nEA"));
